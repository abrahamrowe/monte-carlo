...
The practical use of the tornado chart: if Price has ρ = 0.85 and Variable Cost has ρ = -0.15, that tells you the output is overwhelmingly driven by price uncertainty. If you could reduce your uncertainty about just one input, it should be price.
